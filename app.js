...
const Navigation = ({ activeSection, setActiveSection, language, setLanguage }) => {
    const sections = {
        ...
        mn: [
            { id: 'home', name: 'Нүүр', icon: '🏠' },
            { id: 'nomadic', name: 'Нүүдлийн амьдрал', icon: '⛺' },
            { id: 'language', name: 'Хэл бичиг', icon: '📜' },
        ...
        mn: [
            {
                title: 'Уртын дуу',
                subtitle: 'Урт дуу',
                desc: 'Чөлөөт хэмнэлтэй сунгасан, гоёмсог дуулах хэв маяг нь талын нутгийн уужим орон зай, байгаль болон нүүдлийн амьдралын гүн ухааны сэдвүүдийг илэрхийлдэг.'
            },
            {
                title: 'Богино дуу',
                subtitle: 'Богино дуу',
                desc: 'Тогтмол хэмнэлтэй богино ардын дуунууд, ихэвчлэн өдөр тутмын амьдрал, хайр дурлал, адуу, баяр ёслолын тухай байдаг. Нийгмийн цугларалтад илүү түгээмэл.'
            },
            {
                title: 'Баатарлаг түүх',
                subtitle: 'Туули',
                desc: 'Баатарлаг түүхийг өгүүлсэн урт өгүүллэг шүлэг, ихэвчлэн хөгжмийн зэмсгийн дагалдлагатайгаар тоглогддог. Хэдэн цаг буюу хэдэн өдөр үргэлжилж болно.'
            }
        ],
        ja: [
            {
                title: 'ウルティン・ドゥー',
                subtitle: '長歌',
                desc: '自由なリズムの伸びやかで装飾的な声楽スタイルで、草原の広大さと自然や遊牧生活の哲学的テーマを表現します。'
            },
            {
                title: 'ボギノ・ドゥー',
                subtitle: '短歌',
                desc: '規則的なリズムの短い民謡で、日常生活、愛、馬、お祝いについてよく歌われます。社交的な集まりでより一般的です。'
            },
            {
                title: '叙事詩',
                subtitle: 'トゥーリ',
                desc: '英雄的な物語を語る長い叙事詩で、楽器の伴奏と共に演奏されることが多いです。数時間または数日間続くこともあります。'
            }
        ]
    };
